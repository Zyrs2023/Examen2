<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="Empleado.aspx.cs" Inherits="Examen2progra.Empleado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container text-center">
        ...
        CodigoID: <asp:TextBox ID="tid" class="form-control" runat="server"></asp:TextBox>
